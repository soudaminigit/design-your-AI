...
export const CheckCircleIconOutline: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
  </svg>
);

export const CheckCircleIconFilled: React.FC = () => (
...
export const GoogleIcon: React.FC<{className?: string}> = ({className}) => (
    <svg className={className} role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Google</title><path d="M12.48 10.92v3.28h7.84c-.24 1.84-.85 3.18-1.73 4.1-1.02 1.02-2.37 1.62-3.82 1.62-4.66 0-8.4-3.86-8.4-8.62s3.74-8.62 8.4-8.62c2.66 0 4.44 1.08 5.48 2.1l2.2-2.2C18.47 1.45 15.82 0 12.48 0 5.88 0 .04 5.84.04 12.98s5.84 13.02 12.44 13.02c3.34 0 5.92-1.12 7.84-3.08 2.04-2.04 2.6-4.98 2.6-7.84 0-.58-.06-1.16-.14-1.72h-10.2z"/></svg>
);
